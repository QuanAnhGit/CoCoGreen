...
export function ProductDetail({ onNavigate, onAddToCart }) {
  ...
  return (
    <div className="page-wrapper">
      ...
      <div className={styles.mainGrid}>
        ...
        <div className={styles.info}>
          ...
          <div className={styles.actionRow}>
            ...
            <button className="btn btn-gold" style={{ flex: 1, justifyContent: 'center', fontSize: 15 }}>
              ⚡ Mua ngay
            </button>
          ...
          <div className={styles.ecoTags}>
            {['♻️ Tái chế', '🌱 Hữu cơ', '🌊 Thân thiện môi trường', '🏭 Sản xuất Việt'].map((t) => (
      ...
      {/* ── Tab Content ── */}
      <div className={`${styles.tabContent} animate-fadeIn`}>
        {activeTab === 'desc' && (
